...
/////////////////////////////////////////////////////////////////////////////////
/* HR PANEL - ADD CONTACTS CLIENT - SAVE TO XANO */
/*Location: Work Panel/ SEC Panel / Ticket / Add New Contact */
/////////////////////////////////////////////////////////////////////////////////
$(document).on('knack-record-create.view_1784', function(event, view, record) {
    const safe = value => (value && value.trim() !== "" ? value : null);
    const name = String(record.field_275 || "");
    const type = String(record.field_338 || "");
    const rawPhone332 = record.field_332;
